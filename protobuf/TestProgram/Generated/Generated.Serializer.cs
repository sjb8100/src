            ...
            public static global::Personal.Person.PhoneNumber Deserialize(Stream stream, global::Personal.Person.PhoneNumber instance)
            {
                ...
                while (true)
                {
                    ...
                    switch (keyByte)
                    {
                        ...
                        // Field 2 Varint
                        case 16:
                            instance.Type = (global::Personal.Person.PhoneType)global::SilentOrbit.ProtocolBuffers.ProtocolParser.ReadUInt64(stream);
                            continue;
                    }
...
#pragma warning restore 612
                    case 17:
                        if(key.WireType != global::SilentOrbit.ProtocolBuffers.Wire.Varint)
                            break;
                        instance.FieldQ = (global::Yours.MyMessageV2.MyEnum)global::SilentOrbit.ProtocolBuffers.ProtocolParser.ReadUInt64(stream);
                        continue;
                    case 18:
                        if(key.WireType != global::SilentOrbit.ProtocolBuffers.Wire.Varint)
                            break;
                        instance.FieldR = (global::Yours.MyMessageV2.MyEnum)global::SilentOrbit.ProtocolBuffers.ProtocolParser.ReadUInt64(stream);
                        continue;
                    case 19:
                        if(key.WireType != global::SilentOrbit.ProtocolBuffers.Wire.LengthDelimited)
                            break;
...
#pragma warning restore 612
                    ...
                    case 25:
                        if(key.WireType != global::SilentOrbit.ProtocolBuffers.Wire.Varint)
                            break;
                        instance.NullableEnum = (global::Yours.MyMessageV2.AliasedEnum)global::SilentOrbit.ProtocolBuffers.ProtocolParser.ReadUInt64(stream);
                        continue;
                    default:
                        global::SilentOrbit.ProtocolBuffers.ProtocolParser.SkipKey(stream, key);
                        break;
...
namespace Theirs
{
    public partial class TheirMessage
    {
        ...
        /// <summary>Helper: put the buffer into a MemoryStream before deserializing</summary>
        public static global::Theirs.TheirMessage Deserialize(byte[] buffer, global::Theirs.TheirMessage instance)
        {
            using (var ms = new MemoryStream(buffer))
                Deserialize(ms, instance);
            return instance;
        ...
        /// <summary>Takes the remaining content of the stream and deserialze it into the instance.</summary>
        public static global::Theirs.TheirMessage Deserialize(Stream stream, global::Theirs.TheirMessage instance)
        {
            while (true)
            {
                int keyByte = stream.ReadByte();
        ...
        /// <summary>Read the VarInt length prefix and the given number of bytes from the stream and deserialze it into the instance.</summary>
        public static global::Theirs.TheirMessage DeserializeLengthDelimited(Stream stream, global::Theirs.TheirMessage instance)
        {
            long limit = global::SilentOrbit.ProtocolBuffers.ProtocolParser.ReadUInt32(stream);
            limit += stream.Position;
            while (true)
        ...
        /// <summary>Read the given number of bytes from the stream and deserialze it into the instance.</summary>
        public static global::Theirs.TheirMessage DeserializeLength(Stream stream, int length, global::Theirs.TheirMessage instance)
        {
            long limit = stream.Position + length;
            while (true)
            {
...
namespace Proto.Test
{
    ...
    public partial class MyMessage
    {
        ...
        /// <summary>Helper: put the buffer into a MemoryStream before deserializing</summary>
        public static global::Proto.Test.MyMessage Deserialize(byte[] buffer, global::Proto.Test.MyMessage instance)
        {
            using (var ms = new MemoryStream(buffer))
                Deserialize(ms, instance);
            return instance;
        ...
        /// <summary>Takes the remaining content of the stream and deserialze it into the instance.</summary>
        public static global::Proto.Test.MyMessage Deserialize(Stream stream, global::Proto.Test.MyMessage instance)
        {
            while (true)
            {
                int keyByte = stream.ReadByte();
        ...
        /// <summary>Read the VarInt length prefix and the given number of bytes from the stream and deserialze it into the instance.</summary>
        public static global::Proto.Test.MyMessage DeserializeLengthDelimited(Stream stream, global::Proto.Test.MyMessage instance)
        {
            long limit = global::SilentOrbit.ProtocolBuffers.ProtocolParser.ReadUInt32(stream);
            limit += stream.Position;
            while (true)
        ...
        /// <summary>Read the given number of bytes from the stream and deserialze it into the instance.</summary>
        public static global::Proto.Test.MyMessage DeserializeLength(Stream stream, int length, global::Proto.Test.MyMessage instance)
        {
            long limit = stream.Position + length;
            while (true)
            {
