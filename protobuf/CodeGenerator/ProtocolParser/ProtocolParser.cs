...
namespace ProtoBuf
{
    ...
    {
        ProtoBuf.IMessage New();
        ProtoBuf.IMessage Deserialize(Stream stream);
        ProtoBuf.IMessage DeserializeLengthDelimited(Stream stream);
        ProtoBuf.IMessage DeserializeLength(Stream stream, int length);
        ProtoBuf.IMessage Deserialize(byte[] buffer);
        ProtoBuf.IMessage Deserialize(byte[] buffer, ProtoBuf.IMessage instance);
        ProtoBuf.IMessage Deserialize(Stream stream, ProtoBuf.IMessage instance);
        ProtoBuf.IMessage DeserializeLengthDelimited(Stream stream, ProtoBuf.IMessage instance);
        ProtoBuf.IMessage DeserializeLength(Stream stream, int length, ProtoBuf.IMessage instance);
        void Serialize(Stream stream, ProtoBuf.IMessage instance);
        byte[] SerializeToBytes(ProtoBuf.IMessage instance);
        void SerializeLengthDelimited(Stream stream, ProtoBuf.IMessage instance);
    }
    public interface IMessage
    {
        byte[] SerializeToBytes();
        void SerializeLengthDelimited(Stream stream);
    }
}
// 
