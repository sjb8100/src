...
namespace table
{
	public static partial class TitleDataBaseExtensions
	{
		/// <summary>
		/// 通过[编号]二分快速查表
		/// </summary>
		...
		{
			var key = new TitleDataBase() { dwID = dwID };
		...
		#region Comparer
		class Comparer1 : Comparer<TitleDataBase>
		{
			public override int Compare(TitleDataBase a, TitleDataBase b)
			{
