...
namespace table
{
	public static partial class RechargeDataBaseExtensions
	{
		/// <summary>
		/// 通过[ID]二分快速查表
		/// </summary>
		...
		{
			var key = new RechargeDataBase() { dwID = dwID };
		...
		#region Comparer
		class Comparer1 : Comparer<RechargeDataBase>
		{
			public override int Compare(RechargeDataBase a, RechargeDataBase b)
			{
