...
namespace table
{
	public static partial class CopyDisplayDataBaseExtensions
	{
		/// <summary>
		/// 通过[副本ID]二分快速查表
		/// </summary>
		...
		{
			var key = new CopyDisplayDataBase() { copyId = copyId };
		...
		{
			var key = new CopyDisplayDataBase() { copyId = copyId, waveId = waveId };
		...
		#region Comparer
		class Comparer1 : Comparer<CopyDisplayDataBase>
		{
			public override int Compare(CopyDisplayDataBase a, CopyDisplayDataBase b)
			{
				{ var n = a.copyId.CompareTo(b.copyId); if (n != 0) return n; }
				return 0;
			}
		}
		class Comparer2 : Comparer<CopyDisplayDataBase>
		{
			public override int Compare(CopyDisplayDataBase a, CopyDisplayDataBase b)
			{
				{ var n = a.copyId.CompareTo(b.copyId); if (n != 0) return n; }
