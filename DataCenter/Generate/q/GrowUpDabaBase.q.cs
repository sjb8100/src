...
namespace table
{
	public static partial class GrowUpDabaBaseExtensions
	{
		/// <summary>
		/// 通过[ID]二分快速查表
		/// </summary>
		...
		{
			var key = new GrowUpDabaBase() { dwID = dwID };
		...
		#region Comparer
		class Comparer1 : Comparer<GrowUpDabaBase>
		{
			public override int Compare(GrowUpDabaBase a, GrowUpDabaBase b)
			{
