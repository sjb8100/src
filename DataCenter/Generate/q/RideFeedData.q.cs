...
namespace table
{
	public static partial class RideFeedDataExtensions
	{
		/// <summary>
		/// 通过[坐骑ID]二分快速查表
		/// </summary>
		...
		{
			var key = new RideFeedData() { rideId = rideId };
		...
		{
			var key = new RideFeedData() { rideId = rideId, level = level };
		...
		#region Comparer
		class Comparer1 : Comparer<RideFeedData>
		{
			public override int Compare(RideFeedData a, RideFeedData b)
			{
				{ var n = a.rideId.CompareTo(b.rideId); if (n != 0) return n; }
				return 0;
			}
		}
		class Comparer2 : Comparer<RideFeedData>
		{
			public override int Compare(RideFeedData a, RideFeedData b)
			{
				{ var n = a.rideId.CompareTo(b.rideId); if (n != 0) return n; }
