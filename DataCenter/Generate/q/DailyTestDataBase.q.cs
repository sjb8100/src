...
namespace table
{
	public static partial class DailyTestDataBaseExtensions
	{
		/// <summary>
		/// 通过[ID]二分快速查表
		/// </summary>
		...
		{
			var key = new DailyTestDataBase() { dwID = dwID };
		...
		#region Comparer
		class Comparer1 : Comparer<DailyTestDataBase>
		{
			public override int Compare(DailyTestDataBase a, DailyTestDataBase b)
			{
