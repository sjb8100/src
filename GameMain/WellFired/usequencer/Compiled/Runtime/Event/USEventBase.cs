...
namespace WellFired
{
    ...
    public enum USEventType
    {
        ...
        US_ChangeColorEvent,
        US_SetActiveEvent,
        US_PlayAnimationEvent,
        US_LookAtObjectEvent,
        US_BlendAnimEvent,
        US_OpenDialog,
        US_ShakeCamera,
        US_RotateObjectEvent,
        US_LoadScene,
        US_OpenSeqLoading,
        US_TimeScale,
        US_DisplayImageEvent,
        US_CameraFade,
        US_PrintTextEvent,
        US_ShowBook,
    };
	...
	abstract public class USEventBase : MonoBehaviour 
	{
        ...
        public Engine.IRenderObj GetRenderObj()
        {
            return TimelineContainer.RenderObj;
        }
        ...
        public virtual USEventType GetEventType()
        {
            return USEventType.US_Unknown;
        }
