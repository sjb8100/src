...
namespace WellFired
{
	...
	public class USBlendAnimEvent : USEventBase
    {
        ...
        {
            return USEventType.US_BlendAnimEvent;
        }
        ...
        public string animationNameSource = "";
        public string animationNameDest = "";
		/// <summary>
		...
		public override void ProcessEvent(float deltaTime)
		{
			...
			if(deltaTime < blendPoint)
                animation.CrossFade(animationClipSource.name, fadeLength);
			else
                animation.CrossFade(animationClipDest.name, fadeLength);
		}
