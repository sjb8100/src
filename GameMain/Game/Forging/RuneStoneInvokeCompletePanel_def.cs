...
partial class RuneStoneInvokeCompletePanel: UIPanelBase
{
   ...
   FastComponent         fastComponent;
    ...
    protected override void InitControls()
    {
       ...
       if( null == m_label_Label )
       {
        ...
        m_label_RsName = fastComponent.FastGetComponent<UILabel>("RsName");
       if( null == m_label_RsName )
       {
            Engine.Utility.Log.Error("m_label_RsName 为空，请检查prefab是否缺乏组件");
       }
