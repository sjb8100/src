...
partial class DownloadPanel: UIPanelBase
{
   ...
   FastComponent         fastComponent;
    ...
    UISprite             m_sprite_labelReward;

    UIButton             m_btn_btn_takeReward;

    UILabel              m_label_Name_hui;
    ...
    protected override void InitControls()
    {
       ...
       if( null == m_label_label3 )
       {
        ...
        m_sprite_labelReward = fastComponent.FastGetComponent<UISprite>("labelReward");
       if( null == m_sprite_labelReward )
       {
            Engine.Utility.Log.Error("m_sprite_labelReward 为空，请检查prefab是否缺乏组件");
       }
       ...
       if( null == m_btn_btn_takeReward )
       {
        ...
        m_label_Name_hui = fastComponent.FastGetComponent<UILabel>("Name_hui");
       if( null == m_label_Name_hui )
       {
            Engine.Utility.Log.Error("m_label_Name_hui 为空，请检查prefab是否缺乏组件");
       }
