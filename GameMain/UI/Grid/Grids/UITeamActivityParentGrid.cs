...
class UITeamActivityParentGrid : UIGridBase
{
    ...
    private UISprite m_sp_targetMark = null;
    ...
    public void SetTargetMark(bool enable)
    {
        if (m_sp_targetMark != null && m_sp_targetMark.enabled != enable)
        {
            m_sp_targetMark.enabled = enable;
        }
    }
